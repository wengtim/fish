...
alias g="git"
alias jv="java"
alias jvc="javac -d class/ -cp .:lib/LGoodDatePicker-1.5.3.jar Handler/*.java Lecturer/*.java Students/*.java"
alias jvrun="java -cp .:lib/LGoodDatePicker-1.5.3.jar:class Students.Consultation.Booking"
